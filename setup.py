...
plugin_package = "octoprint_Smoothie-ABL-Delta"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Smoothie-abl-delta"
...
# module
plugin_description = """A simple OctoPrint plugin to ease µDelta Rework Calibration"""
